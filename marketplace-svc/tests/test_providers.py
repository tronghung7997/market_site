...
async def test_dproxy_test_connection_never_creates_an_allocation(client, monkeypatch):
    ...
    # Three read-only calls: list_catalog, credit_summary and
    # list_assignments (all merged into the health dict — see
    # DProxyAdapter.check_health). Still no provision-test / purchase call.
