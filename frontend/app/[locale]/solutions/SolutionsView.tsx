...
const SOLUTION_META = [
  { key: "scraper" as const, icon: Bolt, accent: "iris" as const, priceVnd: 50 },
  { key: "takedown" as const, icon: Shield, accent: "good" as const, priceVnd: 50 },
];

export type SolutionKey = (typeof SOLUTION_META)[number]["key"];
...
/** Rendered by the server page, which resolves each solution's product URL. */
export default function SolutionsView({ hrefs }: { hrefs: Record<SolutionKey, string> }) {
